        ...
        <div>
            <div>
             ...
             <form onSubmit={handleSubmit}>
                    ...
                    <input type="text" name="firstName" value={fullNames.firstName} onChange= {handleInput} id='firstname' />

                    <label htmlFor="lastname">Lastname:</label>
                    <input type="text"  name="lastName" value={fullNames.lastName} onChange= {handleInput} id='lastname'/>
